...
func NewPostsHandler(router *router.Router, usecase posts.Usecase) *PostsHandler {
	...
	postsHandler.router.POST("/api/thread/{slug}/create",
		middleware.ContentTypeJson(postsHandler.CreatePost))
	postsHandler.router.GET("/api/thread/{slug_or_id}/posts", middleware.ContentTypeJson(postsHandler.GetPosts))
	postsHandler.router.GET("/api/post/{id}/details", middleware.ContentTypeJson(postsHandler.GetPostHandler))
	postsHandler.router.POST("/api/post/{id}/details", middleware.ContentTypeJson(postsHandler.UpdatePost))
